...
-(void) configureLeftBarButtonItem {
    ...
    self.postView.nameLabel.text = [NSString stringWithCString:[selectedItem.author.name cStringUsingEncoding:NSUTF8StringEncoding] encoding:NSNonLossyASCIIStringEncoding];
