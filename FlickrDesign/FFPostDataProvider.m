...
-(FFImageCell *) imageCellForTableView: (UITableView *)tableView atIndexPath: (NSIndexPath *)indexPath {
    ...
    cell.descriptionText.text = [NSString stringWithCString:[selectedItem.text cStringUsingEncoding:NSUTF8StringEncoding] encoding:NSNonLossyASCIIStringEncoding];
    return cell;
}
...
-(FFCommentsCell *) commentsCellForTableView: (UITableView *)tableView atIndexPath: (NSIndexPath *)indexPath {
    ...
    cell.nameLabel.text = [NSString stringWithCString:[author.name cStringUsingEncoding:NSUTF8StringEncoding] encoding:NSNonLossyASCIIStringEncoding];
    NSString *text = [NSString stringWithCString:[currentComment.text cStringUsingEncoding:NSUTF8StringEncoding] encoding:NSNonLossyASCIIStringEncoding];
